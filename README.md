...
- packages/mv-wp-v1.4.0-dev.130.zip (Dev)
- packages/mv-wp-v1.3.425.zip (Beta/Stable)
- packages/mimams-var-figma-v2.20.0.zip (latest verified packaged Figma release)

The Figma working source contains a partial v2.20.1 marker. It is not a
published release until the source, UI version, package, and release record are
reconciled and verified together.
